...
export default function AdsError({
  ...
  useEffect(() => {
    console.error('Ad planner error:', error);
  }, [error]);
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center space-y-4 max-w-md mx-auto p-6">
        ...
        <h2 className="text-xl font-semibold text-text">Ad Plan Generation Error</h2>
        <p className="text-sm text-muted">
          {error.message || 'Something went wrong while generating your ad plan.'}
        </p>
